...
setKeymap("i", "<C-d>", "<C-o>:Telescope diagnostics<CR>")
setKeymap("n", "<C-d>", ":Telescope diagnostics<CR>")
setKeymap("v", "<C-d>", "<ESC>:Telescope diagnostics<CR>")
...
setKeymap("n", "<leader>.", ":CodeActionMenu<CR>")
...
setKeymap("n", "<C-S-q>", ":bd<cr>")
setKeymap("n", "<leader>j>", "<C-w><C-j>")
setKeymap("n", "<leader>k", "<C-w><C-k>")
setKeymap("n", "<leader>l>", "<C-w><C-l>")
setKeymap("n", "<leader>h>", "<C-w><C-h>")
setKeymap("n", "[t", ":bp<CR>")
setKeymap("n", "]t", ":bn<CR>")
